...
{% highlight csharp %}
public class Foo{public int Soma(int a, int b){return a+b;}public double Divide(int a, int b){return a/b;}}
{% endhighlight %}
...
{% highlight csharp %}
[TestFixture]public class FooTest{[Test]public void sum_1_plus_1_should_return_2(){Assert.AreEqual(2,new Foo().Soma(1,1));}}
{% endhighlight %}
