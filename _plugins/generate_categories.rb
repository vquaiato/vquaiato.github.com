...
module Jekyll
  ...
  def removeaccents(to_clean)    
    str = String.new(to_clean)
    ...
    def write_category_indexes
      if self.layouts.key? 'category_index'
        ...
        self.categories.keys.each do |category|
          slug = category["slug"]
          slug = category["title"].downcase if slug.nil?
          c = removeaccents(slug)
          self.write_category_index(File.join(dir, c), category)
        end
